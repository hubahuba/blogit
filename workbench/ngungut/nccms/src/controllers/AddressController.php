...
use Ngungut\Nccms\Model\Address;
...
class AddressController extends BaseController {
	...
	public function index()
	{
        ...
        $this->layout->with('script', 'nccms::admin.address.scripts.address')
            ->with('style', 'nccms::admin.address.styles.address');
        $this->layout->content = View::make('nccms::admin.address.address')
