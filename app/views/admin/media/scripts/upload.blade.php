...
<!--uploader-->
{{ HTML::script(asset('js/plugins/fileupload/jquery.iframe-transport.js')) }}
{{ HTML::script(asset('js/plugins/fileupload/jquery.fileupload.js')) }}
<script>
$(function () {
    $('#fileupload').fileupload({
        ...
        progressall: function (e, data) {
            ...
            $.each(json.media, function (index, file) {
                $('<p/>').text(file.name).appendTo('#uploadPreview');
            });
            setTimeout(function(){
