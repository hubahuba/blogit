...
class CategoryController extends BaseController {
	...
	public function index()
	{
        ...
        $this->layout->with('script', 'admin.posts.scripts.categories')
            ->with('style', 'admin.posts.styles.categories');
        $this->layout->content = View::make('admin.posts.categories')
    ...
    public function doCategories(){
        if(Input::has('delete')){
            ...
            return Redirect::to('post/categories');
        }
        $rules = array(
